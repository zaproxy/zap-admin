...
public class HelpGenerator {
    ...
    private static final File TEMPLATE_DIR =
            new File(
                    HelpGenerator.class
                            .getResource("resources/help")
                            .toString()
                            .replace("file:", ""));

    private static void recursiveCopy(File srcFile, File destFile, Map<String, String> tokens)
            throws IOException {
    ...
    private static void generateHelp(File addon, String name, String icon, String intro)
            throws IOException {
        ...
        try {
            ...
            FileUtils.moveFile(new File(addon, "/resources/help/contents/addon.html"), f);
        } catch (IOException e) {
